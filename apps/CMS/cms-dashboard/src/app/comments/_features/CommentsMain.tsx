  ...
  return (
    <div className='my-10'>
      ...
      <div className='w-full justify-center items-center flex'>
        ...
        <div className='w-1/2'>
             <div><button className='btn btn-default bg-white items-center' onClick={handlePrev} style={{ display: currentPage === 1 ? 'none' : 'block' }}><span className='flex items-center gap-2'><FaArrowLeft/>Prev</span></button></div>    
        </div>
        <div className='flex items-center justify-between w-1/2'>
         ...
         <button className='btn btn-default bg-white items-center' onClick={handleNext}>Next<FaArrowRight/></button>
        </div>
        </div>
      </div>
    </div>
