  ...
  return (
    <div>
      <Stack width={'100vw'} gap={6} bgcolor={'#F7F7F8'} suppressHydrationWarning={true} alignItems={'center'} pb={3}>
        <MainBannerFromArticles articlesTitle="PORSCHE 911 GT3" cover="/earth.jpeg" date="2024.04.22" categories="Porsche" />
        <Stack px={12} gap={6} width={'85%'}>
          ...
          <GroupArticlesComp title="Сонирхолтой dddтүүхүүд" categoryId="662771aaebfd0e7cf0eed302" />
          <FooterButtons />
        </Stack>
      </Stack>
    </div>
