  ...
  return (
    <div className="bg-white flex-1 p-6 h-[93.5vh] flex flex-col justify-between">
      ...
      <div className="flex flex-col gap-4">
        <ArticlesButton able={isDisabled} addClass={'bg-slate-200 text-black font-bold hover:text-white '} text="Ноорогт хадгалах" />
        <ArticlesButton able={isDisabled} addClass={'bg-slate-400 text-black font-bold hover:text-white'} text="Нийтлэх" typeText={typeText}/>
      </div>
    </div>
  );
};
