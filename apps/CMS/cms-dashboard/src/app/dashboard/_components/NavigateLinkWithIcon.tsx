...
export const NavigateLinkWithIcon = (props: NavigateLinkWithIconProps) => {
  ...
  return (
    <Link href={myPathName} data-testid="navigate-link-with-icon-test-id" className="h-full font-semibold text-[#121316] rounded-[50px] cursor-pointer flex justify-center items-center bg-[black]">
