...
import { updatedCmsUser } from '@/graphql/resolvers/mutations';
...
describe('update user', () => {
  it('should update a user', async () => {
    const result = await updatedCmsUser!({}, { _id: '1', input }, {}, {} as GraphQLResolveInfo);
  ...
  it('should throw an error if the user cannot be found', async () => {
    try {
      await updatedCmsUser!({}, { _id: '2', input }, {}, {} as GraphQLResolveInfo);
    } catch (error) {
  ...
  it('should throw an error if an error occurs during user retrieval', async () => {
    try {
      await updatedCmsUser!({}, { _id: '1', input }, {}, {} as GraphQLResolveInfo);
    } catch (error) {
