export const PaginationBar = () => {
  return (
    <div className="w-[792px] justify-between items-center h-[68px] flex">
      <button className="border-[1px] border-[#D6D8DB] w-[102px] h-9 rounded-lg flex gap-2 items-center justify-center text-sm font-semibold">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
          <path d="M13.6667 6.16683H3.52499L8.18333 1.5085L6.99999 0.333496L0.333328 7.00016L6.99999 13.6668L8.17499 12.4918L3.52499 7.8335H13.6667V6.16683Z" fill="#1C2024" fill-opacity="0.24" />
        </svg>
        Өмнөх
      </button>
