  ...
  return (
    <div className="flex flex-col gap-[24px]">
      ...
      <div className="flex flex-col gap-[8px] w-[590px]">
        ...
        <Textarea data-testid="mocked-textarea" name="description" value={inputData.description} onChange={handleInputChange} placeholder="Энд бичнэ үү..." className="h-[120px] max-h-[200px]" />
      </div>
