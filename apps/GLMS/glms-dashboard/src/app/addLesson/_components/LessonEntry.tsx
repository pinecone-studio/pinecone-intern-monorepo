  ...
  return (
    <div className="flex flex-col pt-[64px] gap-[32px]">
      <div data-testid="continue topic">
        ...
        <Input data-testid="lesson_input_comp" className="w-[588px] border-gray-400" placeholder="Select" defaultValue={inputData.topic} onChange={handleInputChange('topic')} />
      </div>
      <div data-testid="continue title">
        <p className="font-inter text-base font-semibold leading-5 text-[#121316] pb-[8px]">Title</p>
        <Input data-testid="lesson_input_sec_comp" className="w-[588px] border-gray-400" placeholder="Enter here..." defaultValue={inputData.title} onChange={handleInputChange('title')} />
      </div>
