...
export const TextOrFileQuestionCreate = () => {
  ...
  const uploadTextClass = `flex justify-evenly items-center w-[110px] rounded-l-2xl font-semibold text-md bg-black py-2  ${selectedBtn === 'text' ? 'bg-black text-white' : 'bg-slate-200 text-black'}`;
  const uploadFileClass = `flex justify-evenly items-center w-[110px] rounded-r-2xl font-semibold text-md  py-2  ${selectedBtn === 'file' ? 'bg-black text-white' : 'bg-slate-200 text-black'}`;
