...
import { useCreateSectionMutation, useUpdateLessonMutation } from '../../../generated';
...
const AddSection = () => {
  ...
  return (
    <div data-testid="add-section-form" className="flex flex-col gap-[4px] bg-[#fff] border-1 rounded-[4px] justify-center items-center p-6">
      ...
      <button name="submitBtn" className={`bg-[#121316] rounded-lg w-[280px] h-[56px] text-white flex justify-center items-center btn`} data-testid="create-button" onClick={handleClick}>
        <p className="text-[18px] font-semibold">Хадгалах</p>
      </button>
    </div>
  );
};
