...
const AddSection = () => {
    ...
    return(
        <Stack data-testid="add-section-component" sx={{ display:"flex" , flexDirection:"column" , gap:4 , backgroundColor:"#fff" , borderRadius:4 , justifyContent:"center" , alignItems:"center" , padding:6 }}>
            ...
            <Stack sx={{display:"flex" , flexDirection:"column" , gap:4 }}>
                <Stack>
                    ...
                    <TextField data-testid="add-section-title-input" onChange={(e)=> handleBack("title" , e.target.value)} helperText="" placeholder="Оруулна уу..."></TextField>
                </Stack>
                <Stack>
                    <Typography sx={{fontWeight:"bold"}}>Дэлгэрэнгүй</Typography>
                    <TextField data-testid="add-section-description-input" onChange={(e)=> handleBack("description" , e.target.value)} placeholder="Энд бичнэ үү..."></TextField>
                </Stack>
                <Stack>
        ...
        <Button data-testid="add-section-handle-btn" onClick={handleSubmit} sx={{width:"200px" , backgroundColor:"black" , alignSelf:"center", ":hover":{backgroundColor:"black"}}} variant="contained">+</Button>
