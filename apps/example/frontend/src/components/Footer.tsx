                ...
                <div className='py-16 text-white'>
                        ...
                        <div className='flex gap-8'>
                            <Link href="/">
                                <div className='flex gap-4 items-center group'>
                                    <div className='flex items-center justify-center w-12 h-12 border-2 rounded-full border-zinc-800 duration-300 group-hover:bg-white'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <div className='flex gap-6'>
                            ...
                            <Link href="/"><FaLinkedin className='w-5 h-5' /></Link>
                        </div>
                    </div>
                </div>
            </Container>
