...
import { getRequestByCalendarMonth } from "@/graphql/resolvers/queries";
...
describe("getRequestByMonth", () => {
    it('should return all leave request of specific month', async () => {
        ...
        const result = await getRequestByCalendarMonth?.({}, startDate, {}, {} as GraphQLResolveInfo);
    ...
    it('should throw error', async () => {
        ...
        await expect(getRequestByCalendarMonth?.({}, startDate, {}, {} as GraphQLResolveInfo))
