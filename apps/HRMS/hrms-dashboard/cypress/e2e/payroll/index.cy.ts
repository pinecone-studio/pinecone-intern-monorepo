describe('profile page', () => {
  ...
  it('have been advance salary', () => {
    ...
    cy.get('[data-cy="workAllTime"]').should('exist');
    cy.get('[data-cy="Salary"]').should('exist');
    cy.get('[data-cy="socialSecurity"]').should('exist');
    cy.get('[data-cy="socialSecurityPercent"]').should('exist');
    cy.get('[data-cy="socialSecurityMoney"]').should('exist');
