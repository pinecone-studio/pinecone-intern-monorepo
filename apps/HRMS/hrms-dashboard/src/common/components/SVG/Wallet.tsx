export const Wallet = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <rect width="24" height="24" fill="url(#pattern0_57_17301)" />
      <defs>
        <pattern id="pattern0_57_17301" patternContentUnits="objectBoundingBox" width="1" height="1">
          <use xlinkHref="#image0_57_17301" transform="scale(0.0111111)" />
        </pattern>
        <image
          id="image0_57_17301"
          width="90"
