...
const Salary = 2250000;
const SalaryTax = Salary/100*11.5;
const SalaryFee = Salary-SalaryTax;
const getSalary = SalaryFee-SalaryFee*0.1
    return (
        <div className=" w-[700px] border border-solid border-[#ecedf0] bg-white rounded-lg flex flex-col items-start px-4 pt-2 pb-4 gap-1" >
           ...
           <div className="w-[668px] border border-solid border-[#E0E0E0] rounded-lg flex flex-col">
            <div className="  flex justify-between items-center p-4">
               ...
               <p data-cy="Salary" className="text-sm font-bold">{Salary + "₮"}</p>
            </div>
            <div className="  flex justify-between items-center p-4 border-t border-[#E0E0E0] bg-[#F4F4F4] ">
               ...
               <p data-cy="socialSecurityMoney" className="text-sm font-medium">{"-" + SalaryTax + "₮"}</p>
            </div>
            <div className="  flex justify-between items-center p-4 border-t border-[#E0E0E0] bg-[#F4F4F4] ">
               <div className="flex gap-1">
               ...
               <p data-cy="taxesMoney" className="text-sm  font-medium">{"-" + SalaryFee*0.1 + "₮"}</p>
            </div>
            ...
            <p data-cy="actualMountMoney" className="text-xl font-bold">{ getSalary+ "₮"}</p>
            </div>
           </div>
        </div>
    )
