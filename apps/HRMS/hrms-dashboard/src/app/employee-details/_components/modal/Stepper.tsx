        ...
        {steps.map((step, index) => (
          <React.Fragment key={index}>
            <div data-testid="circle-contain" className="flex-1 relative items-center justify-center px-1">
              <div data-testid="step-circle" className={`flex items-center justify-center w-9 h-9 rounded-full mx-auto ${index <= currentStep ? 'bg-[#121316] text-white' : 'bg-[#ECEDF0] text-black'}`}>
