...
export const FilterJobTitle = () => {
  const { data, loading } = useGetJobTitlesQuery();
  ...
  return (
    <div className="rounded-xl border border-[#ECEDF0] overflow-hidden">
      <select data-cy="filterJob" className="flex bg-white w-fit justify-center items-center rounded-xl border-r-8 border-transparent py-2 px-3 text-sm font-semibold text-main">
