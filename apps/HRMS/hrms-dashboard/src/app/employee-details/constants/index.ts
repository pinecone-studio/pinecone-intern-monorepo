export const createEmployeeText = [
  ...
  { label: 'Имэйл', type: 'text', placeholder: 'Имэйл оруулна уу', name: 'email' },
  { label: 'Хэлтэс', type: 'text', placeholder: 'Хэлтэс оруулна уу', name: 'department' },
  ...
  { label: 'Ажилд орсон огноо', type: 'date', placeholder: 'Ажилд орсон огноо оруулна уу', name: 'dateOfEmployment' },
  { label: 'Төлөв', type: 'text', placeholder: 'Төлөв оруулна уу', name: 'employmentStatus' },
];
...
export const sidebarItems = [
  ...
  { text: 'Цалин', icon: '/svg/Wallet.svg', pathName: '/payroll' },
