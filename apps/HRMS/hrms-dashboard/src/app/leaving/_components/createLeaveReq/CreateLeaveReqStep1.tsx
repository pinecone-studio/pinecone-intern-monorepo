...
export const CreateLeaveReqStep1 = () => {
  const { setLeaveReqStep, date, setDate, userName, setUserName, leaveReason, setLeaveReason, setStepNo } = useContext(LeaveReqCreationContext);
  const [step1Initial, setStep1Initial] = useState();
  ...
  // const raw = localStorage.getItem('CreateLeaveReqStep1');
  // if (!raw) return;
  // if (raw) setStep1Initial(JSON.parse(raw));

  // console.log(step1Initial);
