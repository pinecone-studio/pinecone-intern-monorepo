...
export const YourDetailsPage = ({ onSuccess, onBack, userData, updateUserData }: YourDetailsPageProps) => {
  return (
    <div className="w-[340px] md:w-[400px] h-full md:h-fit flex flex-col items-center justify-center bg-background px-4 " data-testid="details-page-container">
      <div className="w-full max-w-[400px] h-full md:h-fit flex flex-col items-center gap-6 ">
