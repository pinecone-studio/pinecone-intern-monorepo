    ...
    <div className="flex flex-col items-center pt-20 min-h-screen bg-background px-4 gap-6">
      <div className="w-full max-w-[400px] flex flex-col items-center gap-6">
        ...
        <div className="flex justify-center items-center flex-col">
          <h1 className=" font-inter font-semibold tracking-wilder  text-2xl leading-8 text-foreground">How old are you</h1>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
              ...
              <FormItem className="flex  w-full flex-col">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
                      <Button variant={'outline'} className={cn(' border w-full pl-3 text-left font-normal', !field.value && 'text-muted-foreground')}>
          ...
          <div className="flex justify-between">
            <Button className="bg-white text-black border-solid border border-gray-200 rounded-full flex px-4" type="button">
              Back
            </Button>
            <Button className="bg-red-600 rounded-full flex px-4" type="submit">
              Next
            </Button>
          </div>
        </form>
