...
const root = './apps/L1G/restaurant/restaurant-frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join('apps', 'L1G', "restaurant", 'restaurant-frontend', 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
