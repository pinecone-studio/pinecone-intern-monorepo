describe('FoodCreateDialog', () => {
  it('should display an error message if food values are not provided', () => {
    cy.visit('/food');
    cy.get('[data-cy=create-food-dialog-open]').wait(2000).click();
    ...
    cy.get('[data-cy=create-food-category-select-error-message]').should('have.text', 'Категори сонгоно уу!');
  ...
  it('should create new food and show toast success', () => {
    ...
    cy.get('[data-cy=create-food-category-select]').click();
  ...
  it('should show toast error whe create food fails', () => {
    ...
    cy.get('[data-cy=create-food-submit-button]').click().wait(3000);
