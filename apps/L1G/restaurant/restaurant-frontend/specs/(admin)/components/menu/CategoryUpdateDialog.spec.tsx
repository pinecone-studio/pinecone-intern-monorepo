...
describe('CategoryUpdateDialog', () => {
  ...
  it('should render', () => {
    const { getByTestId } = render(
      <MockedProvider mocks={[updateCategoryMock]}>
    ...
    expect(dialogTitle).toHaveTextContent('Ангилал засах');
  });

  it('should render with empty props values', () => {
    const { getByTestId } = render(
      <MockedProvider mocks={[updateCategoryMock]}>
        <CategoryUpdateDialog {...mockEmptyDataProps} />
      </MockedProvider>
    );
  ...
  it('should update category and show toast success', async () => {
