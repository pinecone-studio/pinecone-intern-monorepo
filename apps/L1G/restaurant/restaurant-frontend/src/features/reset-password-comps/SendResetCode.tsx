          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input data-cy="Email-Input" type="email" placeholder="Имэйл хаяг" data-testid="email-input-resetpassword" {...field} />
                  </FormControl>
                  <FormMessage data-cy="Email-Error-Message" />
                </FormItem>
              )}
            />
          </form>
        </Form>
        <Button data-cy="Continue-Button" onClick={() => form.handleSubmit(onSubmit)()} className="text-[14px] font-medium text-white bg-[#441500]" type="button">
          Үргэлжүүлэх
        </Button>
      </div>
    </div>
