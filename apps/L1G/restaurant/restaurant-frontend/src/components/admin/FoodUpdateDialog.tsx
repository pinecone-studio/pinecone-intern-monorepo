...
import { FoodUpdateDialogProps } from '@/utils/FoodCreateAndUpdate';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button data-testid="food-update-dialog-open" variant="secondary" className="flex w-[36px] h-[36px] rounded-md px-4 py-2 bg-[#F4F4F5]">
