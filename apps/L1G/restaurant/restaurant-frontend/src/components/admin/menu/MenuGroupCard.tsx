...
export const MenuGroupCard = () => {
  ...
  return (
    <Card data-testid="menu-group" className="flex flex-col gap-4 p-8">
      <div className="flex justify-between items-center">
        <CardTitle data-testid="menu-group-title" className="text-xl leading-[28px] font-semibold text-[#000000]">
          Цэс удирдах
        </CardTitle>
      ...
      <Tabs defaultValue="Бүгд">
        ...
        <TabsContent value="Бүгд">
          <CardContent data-testid="menu-group-card" className="gap-6">
                ...
                <div className="flex justify-between items-center p-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <DeleteDialog title="Цэснээс хасах" comment="Хасахдаа итгэлтэй байна уу" submitText="Хасах" onClick={() => handleCategoryDelete(category?.categoryId as string)}>
                      <div data-testid={`category-delete-dialog-trigger-${i}`}>
            ...
            {discountsData?.getDiscounts.map((discount, i) => (
              <div data-testid={`menu-discount-list-${i}`} key={discount?.discountId} className="gap-4 items-start">
                <div className="flex justify-between items-center p-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <DeleteDialog title="Цэснээс хасах" comment="Хасахдаа итгэлтэй байна уу" submitText="Хасах" onClick={() => handleDiscountDelete(discount?.discountId as string)}>
                      <div data-testid={`discount-delete-dialog-trigger-${i}`}>
                        <Trash className="w-4 h-4" />
                      </div>
                    </DeleteDialog>
                  </div>
