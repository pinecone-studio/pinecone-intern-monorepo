        ...
        <div className="w-screen h-screen flex items-center justify-center ">
          <div className="w-[400px], h-[244px] gap-[24px] flex flex-col justify-center items-center ">
            ...
            <div className="flex flex-col gap-7">
              <input id="password" value={age} onChange={handleAgeChange} placeholder="age" className="w-[400px] h-[36px] px-3 py-2 border-[1px] border-[#E4E4E7] rounded-[6px]" type="text" />
