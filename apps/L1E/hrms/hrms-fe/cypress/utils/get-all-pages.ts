...
const root = './apps/L1E/hrms/hrms-fe/src/app';
...
const searchDepth = (folderPath: string) => {
  ...
  if (rootFolders.includes('page.tsx')) {
    pages.push(`/apps/L1E/hrms/hrms-fe${folderPath}`);
  }
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L1E/hrms/hrms-fe'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
