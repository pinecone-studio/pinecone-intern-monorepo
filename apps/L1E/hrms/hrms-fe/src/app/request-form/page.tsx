...
import { Employee, EmployeeStatus, RequestInput, RequestStatus, useCreateRequestMutation, useGetEmployeesQuery } from '@/generated';
...
const Page = () => {
  ...
  return (
    <div className="h-screen w-screen bg-neutral-100 pt-10">
