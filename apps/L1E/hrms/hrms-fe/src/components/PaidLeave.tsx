...
export const PaidLeave = ({ availablePaidDays }: PaidLeaveProps) => {
  return (
    <HoverCard>
      <HoverCardContent className="w-40 mb-2" align="center" side="top">
        <p className="text-sm">Ажилд орсноос хойш 1 жилийн хугацаанд 5 хоног цалинтай чөлөө авах боломжтой.</p>
      </HoverCardContent>
