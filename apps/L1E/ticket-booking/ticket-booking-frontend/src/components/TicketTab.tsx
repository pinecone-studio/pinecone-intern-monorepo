    ...
    <>
      {activeTab === 'ticket' && (
        <div className="w-full h-full bg-[#F4F4F5] px-[200px] py-9 relative">
          ...
          {ticketAddDialog && (
            <div className="fixed w-full h-screen top-0 left-0 bg-black bg-opacity-30">
              <div className="w-[592px] h-fit py-9 px-6 text-black bg-white mx-auto border border-[#E4E4E7] rounded-lg">
