...
export const TicketTab = ({ activeTab }: TicketTabProps) => {
    return (
        <>
            {activeTab === "ticket" && <div className="w-full h-full bg-[#F4F4F5] px-[200px] py-9">
                <div className="mx-auto space-y-6">
                    <div className="flex justify-between items-center">
                        ...
                        <button className="text-white bg-black rounded-md py-2 px-4 flex items-center gap-2">Тасалбар нэмэх<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <g clip-path="url(#clip0_8891_2033)">
                                <path d="M7.99999 5.33337V10.6667M5.33333 8.00004H10.6667M14.6667 8.00004C14.6667 11.6819 11.6819 14.6667 7.99999 14.6667C4.3181 14.6667 1.33333 11.6819 1.33333 8.00004C1.33333 4.31814 4.3181 1.33337 7.99999 1.33337C11.6819 1.33337 14.6667 4.31814 14.6667 8.00004Z" stroke="#FAFAFA" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                            <defs>
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex gap-2">
                            ...
                            <button className="flex gap-2 bg-white rounded-md py-2 px-3 items-center border border-[#E4E4E7]">Цэвэрлэх<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M12.1762 3.76111L12.2133 3.7865C12.2576 3.83075 12.2576 3.90241 12.2133 3.94666L8.5141 7.64685L8.16058 8.00037L12.2133 12.0531C12.2576 12.0974 12.2576 12.1689 12.2133 12.2133C12.1691 12.2575 12.0974 12.2575 12.0532 12.2133L8.00043 8.16052L7.64691 8.51404L3.94672 12.2133C3.91345 12.2465 3.86465 12.2553 3.82367 12.2386L3.78656 12.2133C3.7533 12.1799 3.74526 12.1312 3.76215 12.0902L3.78656 12.0531L7.83929 8.00037L7.48578 7.64685L3.78656 3.94666C3.74235 3.90239 3.74232 3.83074 3.78656 3.7865C3.83079 3.74227 3.90244 3.74229 3.94672 3.7865L7.64691 7.48572L8.00043 7.83923L12.0532 3.7865C12.0863 3.75333 12.1353 3.74451 12.1762 3.76111Z" fill="#09090B" stroke="#18181B" />
                            </svg></button>
                        </div>
                        <DatePickerAdmin />
                    </div>
