...
describe('ConcertsHome Component', () => {
  ...
  describe('Component Structure', () => {
    ...
    it('renders all 9 concert cards', () => {
      const concertCards = document.querySelectorAll('[data-testid="concert-card"]') || document.querySelectorAll('div > div');
  ...
  describe('Icons and Visual Elements', () => {
    ...
    it('calendar icons have correct stroke properties', () => {
      ...
      calendarPaths.forEach((path) => {
        expect(path.getAttribute('stroke')).toBe('#FAFAFA');
  ...
  describe('Content Validation', () => {
    ...
    it('handles various price formats', () => {
      const prices = ["200'000$", "120'000$", "180'000$", "250'000$", "300'000$", "150'000$", "140'000$", "500'000$", "220'000$"];
    ...
    it('displays diverse artist lineup', () => {
      const artists = ['Coldplay', 'DJ Wave', 'Imagine Dragons', 'Skrillex', 'Green Day', 'Beethoven Lives', 'Miles Quartet', 'BTS', 'Arctic Monkeys'];
