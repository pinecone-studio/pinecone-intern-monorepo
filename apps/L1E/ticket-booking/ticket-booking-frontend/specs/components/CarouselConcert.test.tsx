...
describe('CarouselConcert Component', () => {
    ...
    describe('Auto-rotation', () => {
        ...
        it('clears interval on component unmount', () => {
            ...
            const { unmount } = render(<CarouselConcert />);
            unmount();
        ...
        it('applies correct button styling', () => {
            ...
            [prevButton, nextButton].forEach(button => {
                expect(button).toHaveClass(
                    'absolute', 'top-1/2', '-translate-y-1/2', 'bg-white/20',
                    'text-white', 'p-3', 'rounded-full', 'transition-all', 'duration-300', 'z-20'
                );
            });
        });
