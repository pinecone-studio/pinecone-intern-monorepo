  ...
  return (
    <Container>
      <div className="px-28 py-12 flex gap-6 min-h-[48rem] max-h-fit max-sm:h-full max-sm:px-3 max-sm:grid max-sm:gap-6  max-md:h-full max-md:px-3 max-md:grid max-md:gap-6 max-lg:h-full max-lg:px-3 max-lg:grid max-lg:gap-6  max-xl:h-full max-xl:px-3 max-xl:grid max-xl:gap-6">
        <div className="flex flex-col gap-2 max-sm:grid max-sm:grid-cols-2 max-sm:h-fit root:text-black max-md:grid max-md:grid-cols-2 max-md:h-fit max-lg:grid max-lg:grid-cols-2 max-lg:h-fit max-xl:grid max-xl:grid-cols-3 max-xl:h-fit">
          <button
            data-cy="Profile-Page"
            onClick={() => setSelected('profile')}
            className={`px-3 py-2 text-sm font-light w-56 rounded-lg flex justify-start  max-md:w-full   ${selected === 'profile' ? 'text-white bg-[#131313]' : 'dark:text-gray-300 text-black'}`}
          >
          ...
          <button
            ...
            className={`px-3 py-2 text-sm font-light rounded-lg flex justify-start  max-md:w-full   ${selected === 'history' ? 'text-white bg-[#131313]' : 'dark:text-gray-300 text-black'}`}
          >
            Захиалгын түүх
          </button>
          <button
            ...
            className={`px-3 py-2 text-sm font-light rounded-lg flex justify-start  max-md:w-full   ${selected === 'forgetPassword' ? 'text-white bg-[#131313]' : 'dark:text-gray-300 text-black'}`}
          >
            Нууц үг сэргээх
          </button>
        </div>
