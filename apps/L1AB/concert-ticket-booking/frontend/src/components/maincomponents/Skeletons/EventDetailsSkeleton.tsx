...
export const EventDetailsSkeleton = () => {
  return (
    <div>
      <Skeleton className="relative h-[250px] w-full bg-gray-900">
        <Skeleton className="">
          <div className="absolute h-fit grid gap-3 top-12 left-24 backdrop-blur-sm px-4 py-2 ">
            <Skeleton className=" bg-gray-800 border px-3 py-[6px] text-[16px] w-[120px] max-sm:w-[98px] max-sm:h-[30px] h-[36px] text-white border-[#FAFAFA33] rounded-full"></Skeleton>
            <div className="grid h-fit gap-6 w-fit">
              <Skeleton className="text-5xl bg-gray-800 font-bold max-sm:text-sm max-sm:px-2   max-sm:py-1  text-white w-[380px] h-[48px] max-sm:w-[166px] max-sm:h-[28px]"></Skeleton>
              <div className="flex gap-2">
                <Skeleton className="flex bg-gray-800 items-center gap-2 w-[24px] h-[24px] max-sm:w-[9px] max-sm:h-[9px]"></Skeleton>
                <Skeleton className="flex bg-gray-800 items-center gap-2 w-[105px] h-[24px] max-sm:w-[38px] max-sm:h-[18px]"></Skeleton>
              </div>
            </div>
          </div>
        </Skeleton>
      ...
      <div className="flex px-[212px] py-12  max-sm:grid max-sm:px-3 max-sm:gap-3 max-md:grid max-md:px-3 max-md:gap-3 max-lg:grid max-lg:px-3 max-lg:gap-3 max-xl:grid max-xl:px-3 max-xl:gap-3 max-2xl:grid max-2xl:px-3 max-2xl:gap-3">
        <div className="flex-1 grid gap-5">
          ...
          <div className="grid gap-2">
            ...
            <Skeleton className="h-[560px] w-full relative bg-gray-900 max-sm:h-[300px]"></Skeleton>
          </div>
        </div>
        ...
        <div className="w-fit  max-md:px-36 max-sm:px-0 max-lg:px-44  max-xl:w-full max-2xl:w-full">
          <div className="rounded-2xl px-6">
            ...
            <div className="grid h-fit gap-2 ">
              <Skeleton className="w-[284px] h-[308px] bg-gray-900"></Skeleton>
              <Skeleton className=" text-black w-[284px] h-[40px] bg-gray-900 py-2 px-4 my-6 hover:bg-[#6fcceb]"></Skeleton>
            </div>
          </div>
        </div>
      </div>
