import { DetailsUpcomingBookings } from '@/components/admin/assets/DetailsUpcomingBookings';
...
describe('DetailsUpcomingBookings Component', () => {
    ...
    render(<DetailsUpcomingBookings mockBookings={mockBookings}/>);
  ...
  it('should display a "No upcoming bookings available" message when there are no bookings', async () => {
    render(<DetailsUpcomingBookings mockBookings={[]} />);

    await waitFor(() => screen.getByText('Upcoming Bookings'));
