...
const BookingsCancelPage = () => {
  return (
    <div className="w-screen flex flex-col justify-center items-center">
      <div className="w-screen flex justify-center">
        <div className="w-[1280px] h-[40px] flex items-center justify-between">
          <div className="flex gap-2">
            <div className="w-[20px] h-[20px] border rounded-full bg-blue-600"></div>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-[1280px] h-[64px] flex gap-2">
          <div className="w-[20px] h-[20px] border bg-black rounded-full"></div>
          <h1 className="font-bold">Pedia</h1>
        </div>
      </div>
    </div>
...
export default BookingsCancelPage;
