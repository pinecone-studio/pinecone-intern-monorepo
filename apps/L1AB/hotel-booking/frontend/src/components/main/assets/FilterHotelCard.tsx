...
export const FilterHotelCard = ({ id, name, image, rating, stars, room }: FilterHotelCardProps) => {
        ...
        <div className="p-5 flex flex-col justify-between w-full">
          ...
          <div className="flex justify-between items-end">
            <div className="flex gap-2 items-center">
              <div className="font-semibold bg-blue-600 rounded-full text-xs px-[10px] py-[2px] w-fit text-white">
                {rating}
              </div>
              <p>Excellent</p>
            </div>
            <div className="space-y-1 text-end">
              <div>
                ...
                <h6 className="text-xl">
                  {typeof roomPrice === 'number' ? `${roomPrice.toLocaleString()}₮` : roomPrice}
                </h6>
              </div>
              <p className="text-xs">Total price depends on booking</p>
            </div>
          </div>
        </div>
      </div>
