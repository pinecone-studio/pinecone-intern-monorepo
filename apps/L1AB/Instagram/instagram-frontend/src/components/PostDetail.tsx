    ...
    <Dialog>
      ...
      <DialogContent className="max-w-[90vw] w-fit bg-transparent border-none p-0">
        <div className="relative flex w-full h-[74vh] bg-background">
          <div className="h-full w-fit border relative rounded-md flex max-w-lg overflow-hidden">
          ...
          <div className="flex w-[456px] h-full gap-4 flex-col p-4">
            <div className="flex items-center justify-between">
              <div className="flex gap-2 items-center">
                <div className="w-10 h-10 rounded-full border overflow-hidden relative">
                  <Image alt="no picture" src={userProfile} fill />
                </div>
                <div className="font-semibold">{userName}</div>
              </div>
              <MoreVertical className="w-4 h-4 items-end" />
            </div>
            <span className="border border-[1px] border-[#E4E4E7] h-[1px] w-[432px]"></span>
            <div className="flex flex-col gap-1">
              <div className="flex gap-2 items-center w-[336px] h-[40px]">
                <div className="w-10 h-10 rounded-full border overflow-hidden relative">
                  <Image className="" alt="no picture" src={userProfile} fill />
                </div>
                <div>
              ...
              <span className="border border-[1px] border-[#E4E4E7] h-[1px] w-[432px]" />
              ...
              <div>
                <p className="text-xs text-[#71717A] p-2">1 day ago</p>
              </div>
              <span className="border border-[1px] border-[#E4E4E7] h-[1px] w-[432px]" />
