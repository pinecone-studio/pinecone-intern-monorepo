  ...
  return (
    <>
      <motion.nav
        ...
        className={`z-10 drawer bg-white fixed space-y-5 dark:bg-black  dark:text-white border h-full left-[80px] rounded-r-2xl divide-y divide-slate-200 transition-transform duration-100 ${
          isOpen ? 'w-[411px]' : 'w-0'
        }`}
        style={{
      ...
      >
        <div>
          <div className="space-y-5 px-4 py-6">
            <h1 className="font-semibold dark:text-white  text-2xl">Notifications</h1>
            <Notifications />
          </div>
        </div>
      </motion.nav>
