  ...
  return (
    <>
      <motion.nav
        ...
        className={`drawer fixed z-10 bg-white  dark:bg-black space-y-5 w-[411px]  h-full left-[80px] py-6 px-4 transition-transform duration-100 shadow shadow-neutral-200 ${
          isOpen ? 'translate-x-[-411px]' : 'translate-x-0'
        }`}
      >
        <div>
          <div className="space-y-5">
            <h1 className="font-semibold  dark:text-black text-2xl">Notifications</h1>
            <Notifications />
          </div>
        </div>
      </motion.nav>
