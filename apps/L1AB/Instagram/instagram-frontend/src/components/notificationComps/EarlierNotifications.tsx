...
interface PropsType {
  earlierNotifications: GetNotificationsByUserIdQuery['getNotificationsByUserId'];
}

const EarlierNotifications = ({ earlierNotifications }: PropsType) => {
  return (
    <div>
      {earlierNotifications.length > 0 && (
        <div>
          <h3 className="font-bold text-lg mb-4 ">Earlier</h3>
          <div className="flex flex-col gap-4 ">
            {earlierNotifications.map((el, index) => {
