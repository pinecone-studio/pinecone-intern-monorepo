...
interface PropsType {
  yesterdayNotifications: GetNotificationsByUserIdQuery['getNotificationsByUserId'];
}

const YesterdayNotifications = ({ yesterdayNotifications }: PropsType) => {
  return (
    <div>
      {yesterdayNotifications.length > 0 && (
        <div>
          <h3 className="font-bold dark:bg-black text-lg mb-4 ">Yesterday</h3>
          <div className="flex flex-col gap-4">
            {yesterdayNotifications.map((el, index) => {
