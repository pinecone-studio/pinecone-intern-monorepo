  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col w-[350px] gap-[24px]">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="text-center">
              ...
              <FormControl>
                <Input placeholder="name@example.com" {...field} className="w-[350px] h-[36px] rounded-2xl" />
              </FormControl>
        ...
        />
        <Button type="submit" data-testid="submit" className="w-[350px] h-[36px] bg-[#E11D48] hover:bg-red-700">
          Continue
        </Button>
