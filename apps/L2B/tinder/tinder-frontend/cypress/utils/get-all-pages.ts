...
const root = './apps/L2B/tinder/tinder-frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L2B/tinder/tinder-frontend'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
