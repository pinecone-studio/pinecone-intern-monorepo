...
const root = './apps/L2B/hotel-booking/hotel-client/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L2B/hotel-booking/hotel-client'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
