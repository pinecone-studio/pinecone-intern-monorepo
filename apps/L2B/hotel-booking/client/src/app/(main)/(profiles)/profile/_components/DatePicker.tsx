    ...
    <FormItem className="flex flex-col w-[324px]">
      ...
      <Popover>
        <PopoverTrigger asChild>
          <FormControl>
            <Button data-cy="Personal-Birth-Drop-Down" variant="outline" className={`w-full flex justify-between border font-extralight ${!field.value && 'text-muted-foreground'}`}>
