...
<div data-testid="card-component" className="border-2 max-w-[380px] h-[424px] m-auto rounded-xl">
    ...
    <div className="p-4">
        ...
        <div className="flex font-[intern] text-sm font-normal gap-3 mt-2 flex-col ">
            <p className="flex gap-2"><Wifi size={20} width={18} /> Free wifi</p>
            <p className="flex gap-2"><Flower size={20} width={18}/>Spa access</p>
            <p className="flex gap-2"><ParkingCircle size={20} width={18}/>Free self parking</p>
        </div>
