...
export const Footer = () => {
  return (
    <div className="w-screen py-10 flex justify-center items-start gap-7">
      <div className="w-[75%] m-auto flex justify-between text-sm">
        ...
        <div className="flex flex-col gap-3 w-[90px] h-29 ">
          <p className="font-light">Other</p>
          <p>About us</p>
          <p>Careers</p>
          <p>Travel guides</p>
        </div>
