...
const root = './apps/L2B/hotel-booking/client/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L2B/hotel-booking/client'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
