      ...
      <DialogContent className="w-[600px]" data-cy="order-dialog">
        ...
        >
          <div className="flex gap-2">
            <p className="text-2xl font-bold text-[#1D1F24]" data-cy="dialog-order-number">
              {order.orderNumber}
            </p>
            <p className="text-2xl text-[#3F4145]" data-cy="dialog-table-number">
              {order.table}
            </p>
          </div>
          <div className="font-bold" data-cy="dialog-order-time">
            🕒 {order.time}
          </div>
        </div>
        ...
        <div
          ...
          data-cy="dialog-status"
        >
          <p>Төлөв:</p>
          <Select>
            <SelectTrigger className="w-[160px]" data-cy="dialog-status-trigger">
              <SelectValue placeholder={order.status} data-cy="dialog-status-value" />
            </SelectTrigger>
            <SelectContent data-cy="dialog-status-options">
              ...
              <SelectItem value="хийгдэж буй" data-cy="dialog-status-progress">Хийгдэж буй</SelectItem>
        ...
        <div
          ...
          data-cy="dialog-total"
        >
          <p>Нийлбэр дүн:</p>
          <p className="text-xl font-bold" data-cy="dialog-total-price">
