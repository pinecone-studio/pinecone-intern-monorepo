...
export const OrderStatusCard = ({
  ...
  const statusType = status === 'done'
    ? { label: 'Дууссан', color: 'bg-[#F4F4F5]' }
    : { label: 'Бэлтгэгдэж буй', color: 'bg-yellow-100' };
  ...
  return (
    <div className="flex flex-col p-4 justify-between w-full h-[10vh] border-[1px] border-[#E4E4E7] rounded-xl bg-white cursor-pointer">
      <div className="flex gap-2 items-center">
        ...
        <div className={`px-3 rounded-full ${statusType.color} text-[0.8em] flex justify-center items-center h-[5vw]`}>
          {statusType.label}
        </div>
      </div>
