...
const root = './apps/L2A/real-estate/frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L2A/real-estate/frontend'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
