...
export const CreatePostDistrict = ({ name, value, onChange, onBlur, error }: Props) => {
  return (
    <div>
      <label htmlFor={name} className="block text-sm text-[#09090B] pb-1">Дүүрэг</label>
      <input
        id={name}
        name={name}
        type="text"
        ...
        onChange={onChange}
        onBlur={onBlur}
        placeholder="Дүүрэг заавал оруулна уу!"
