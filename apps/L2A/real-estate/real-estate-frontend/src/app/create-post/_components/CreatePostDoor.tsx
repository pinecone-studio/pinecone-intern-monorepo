...
export const CreatePostDoor = ({ name, value, onChange, onBlur, error }: Props) => {
  return (
    <div>
      <label htmlFor={name} className="block text-sm text-[#09090B] pb-1">Хаалга</label>
      <input
        id={name}
        name={name}
        type="text"
        ...
        onChange={onChange}
        onBlur={onBlur}
        placeholder="Хаалганы загвар аа оруулна уу"
        data-testid="door"
