...
export const CreatePostCity = ({ name, value, onChange, onBlur, error }: Props) => {
  return (
    <div>
      <label htmlFor={name} className="block text-sm text-[#09090B] pb-1">Хот</label>
      <input
        id={name}
        name={name}
        type="text"
        ...
        onChange={onChange}
        onBlur={onBlur}
        placeholder="Хот заавал оруулна уу!"
        data-testid="City"
