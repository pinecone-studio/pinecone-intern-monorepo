...
export const CreatePostBalcony = ({ name, value, onChange, onBlur, error }: Props) => {
  return (
    <div>
      <label htmlFor={name} className="block text-sm text-[#09090B] pb-1">Тагт</label>
      <input
        id={name}
        name={name}
        type="text"
        ...
        onChange={onChange}
        onBlur={onBlur}
        placeholder="Тагтны тоо оруулна уу"
        data-testid="balcony"
