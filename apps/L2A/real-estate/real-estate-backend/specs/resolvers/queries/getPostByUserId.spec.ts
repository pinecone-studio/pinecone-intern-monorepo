import { getPostsByUserId } from '../../../src/resolvers/queries';
...
describe('getPostsByUserId', () => {
  ...
  it('should return posts for a given propertyOwnerId', async () => {
    ...
    const result = await getPostsByUserId(null, { propertyOwnerId });
  ...
  it('should return an empty array if an error occurs', async () => {
    ...
    const result = await getPostsByUserId(null, { propertyOwnerId: 'bad-id' });
  ...
  it('should return an empty array if ObjectId constructor throws', async () => {
    ...
    const result = await getPostsByUserId(null, { propertyOwnerId: 'invalid-id' });
