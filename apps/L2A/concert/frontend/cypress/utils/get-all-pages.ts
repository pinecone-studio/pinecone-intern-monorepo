...
const root = './apps/L2A/concert/frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L2A/concert/frontend'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
