export const SignUp = () => {
  return (
    <div data-cy="signup-form" className="bg-black flex justify-center">
      <div className="w-[446px] h-[464px] border-[1px]  border-[#27272A] rounded-2xl">
        ...
        <div className="w-[350px] h-[220px] ml-[48px]">
          ...
          <div className="text-[#A1A1AA] mt-[25px] text-sm">
            Та бүртгэлтэй хаяггүй бол нэвтрэх хэсгээр <br /> орно уу.
          </div>
        </div>
      </div>
    </div>
