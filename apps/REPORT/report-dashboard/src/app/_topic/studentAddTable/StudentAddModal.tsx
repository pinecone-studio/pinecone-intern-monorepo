    ...
    <div className="flex justify-between mb-10">
      ...
      <Dialog>
        ...
        <DialogContent>
          ...
          <Input data-testid="email-input" placeholder="email@example.com" />
          ...
          <Button data-testid="add-student-button" className="w-[200px] ">
