...
describe('ChatInput Component', () => {
  it('should render input and send button', () => {
    ...
    mount(<ChatInput input="" isStreaming={false} onChange={() => onChange} onSend={() => onSend} onStop={() => onStop} />);
  ...
  it('should show stop button when streaming', () => {
    ...
    const onChange = cy.stub().as('onChangeStub');
    const onStop = cy.stub().as('onStopStub');
    mount(<ChatInput input="streaming test" isStreaming={true} onChange={() => onChange} onSend={() => onSend} onStop={() => onStop} />);
  ...
  it('should call onSend when Enter is pressed', () => {
    ...
    const onStop = cy.stub().as('onStopStub');
    const onSend = cy.stub().as('onSendStub');
    mount(<ChatInput input="test" isStreaming={false} onChange={() => onChange} onSend={() => onSend} onStop={() => onStop} />);
