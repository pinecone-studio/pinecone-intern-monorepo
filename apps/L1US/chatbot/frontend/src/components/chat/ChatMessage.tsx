  ...
  return (
    <div className={`flex ${role === 'user' ? 'justify-end' : 'justify-start'}`}>
      <div className="max-w-[80%] space-y-2">
        ...
        {role === 'bot' && (
          <Button size="sm" variant="ghost" className="text-xs text-muted-foreground hover:text-black dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-700 px-2" onClick={handleCopy}>
