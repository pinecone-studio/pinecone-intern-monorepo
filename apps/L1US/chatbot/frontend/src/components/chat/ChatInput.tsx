...
export const ChatInput = ({ input, isStreaming, onChange, onSend, onStop }: Props) => (
  <div className="relative flex items-center">
    <Input
      ...
      placeholder="Message"
      className="bg-gray-100 dark:bg-gray-900 text-black dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border-gray-300 dark:border-gray-700 focus:ring-0 focus:border-black dark:focus:border-white pr-12"
    />
    {isStreaming ? (
