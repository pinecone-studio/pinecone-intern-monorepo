...
describe('getUser', () => {
  ...
  it('should throw an error for invalid userId format', async () => {
    await expect(getUser!({}, { id: invalidUserId }, {} as any, {} as GraphQLResolveInfo))
  ...
  it('should return user data when given a valid userId', async () => {
    ...
    const result = await getUser!({}, { id: validUserId }, {} as any, {} as GraphQLResolveInfo);
  ...
  it('should throw an error if user is not found', async () => {
    ...
    await expect(getUser!({}, { id: validUserId }, {} as any, {} as GraphQLResolveInfo))
