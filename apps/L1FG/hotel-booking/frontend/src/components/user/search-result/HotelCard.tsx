    ...
    <div className="w-[872px] flex border border-[#E4E4E7] rounded-md">
      ...
      <div className="w-[477px] p-5 flex">
        ...
        <div className="w-[88px] flex flex-col gap-1 justify-end">
          ...
          <p className="text-[20px] leading-[28px] font-[500] text-[#09090B]">{formatPrice(10000)}₮</p>
          <p className="text-[12px] leading-[16px] font-[400] text-[#09090B]">{formatPrice(10000 * useNightsCount())}₮ total</p>
        </div>
      </div>
    </div>
  );
