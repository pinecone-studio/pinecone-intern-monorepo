...
import { HotelLocationProps } from './type';

export const Location = ({ locationName, setLocationName, handleEditHotelLocation }: HotelLocationProps) => {
  return (
    <div className="border rounded-[8px] border-[#E4E4E7] bg-white flex flex-col px-6 pt-4 pb-6 gap-4">
      ...
      <p className="text-[#09090B] font-Inter text-sm font-medium">{locationName || '-/-'}</p>
    </div>
  );
};
