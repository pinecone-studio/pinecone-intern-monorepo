...
import { HotelLocationProps } from '@/components/admin/add-hotel/type';
...
export const LocationDialog = ({ locationName, setLocationName, handleEditHotelLocation }: HotelLocationProps) => {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-[480px] w-full gap-6">
        ...
        <div className="flex justify-between">
          ...
          <AlertDialogAction onClick={handleEditHotelLocation} className="px-4 py-2 bg-[#2563EB] rounded-[6px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] hover:bg-[#256eeb]">
            Save
          </AlertDialogAction>
        </div>
      </AlertDialogContent>
