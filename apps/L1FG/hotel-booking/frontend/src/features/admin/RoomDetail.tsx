...
// import { useEditRoomGeneralInfoMutation, useEditRoomImagesMutation, useEditRoomServicesMutation, useGetRoomsByHotelIdQuery } from '@/generated';
...
export const RoomDetailPage = () => {
  ...
  //   const { data } = useGetRoomsByHotelIdQuery({ variables: { hotelId: roomId } });
  //   const roomData = data?.getRoomsByHotelId;
