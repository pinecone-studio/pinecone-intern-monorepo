/*eslint-disable*/
import { BasicInputFieldProps, FormData, TicketSectionProps } from '../../../components/adminfeature/concert-type';
...
interface FormContextProps {
  ...
  handleDatesSelect: (dates: Date[] | undefined) => void;
}
...
export const FormSection = ({ formData, errors, formContext }: FormSectionProps) => {
  const { addArtist, handleArtistChange, handleChange, removeArtist, handleDatesSelect } = formContext;
