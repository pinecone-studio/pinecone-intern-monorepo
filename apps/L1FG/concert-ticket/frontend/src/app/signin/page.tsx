          ...
          <div className="space-y-4">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="w-2/3 space-y-6">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative w-[350px]">
                          ...
                          />
                          <button
                            data-cy="signin-eye-show"
                            type="button"
                            className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white"
                            onClick={(e) => {
                              e.preventDefault();
                              setShowPassword((prev) => !prev);
                              const inputElement = document.querySelector('[data-cy="signin-password-input"]');
                ...
                <Button data-cy="signin-button" disabled={isSubmitting} className="w-[350px] h-[36px] hover:bg-blue-600 bg-[#00B7F4] text-black text-sm font-light rounded-sm" type="submit">
                  {isSubmitting ? 'Нэвтрэх...' : 'Нэвтрэх'}
                </Button>
              </form>
            </Form>
          </div>
