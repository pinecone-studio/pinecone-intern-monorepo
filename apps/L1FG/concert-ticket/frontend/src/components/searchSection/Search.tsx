    ...
    <div className="flex flex-row gap-4">
      ...
      <Popover data-testid="">
        <PopoverTrigger data-testid="" asChild>
          <Button data-testid="add-calendar-open-table-btn" variant={'outline'} className={cn('w-[180px] justify-start text-left font-normal bg-stone-900 text-white')}>
        ...
        <PopoverContent data-testid="" className="w-auto p-0" align="start">
          <Calendar data-testid="select-date-modal" mode="single" selected={selected} onSelect={onSelect} initialFocus />
        </PopoverContent>
      </Popover>
    </div>
  );
