...
describe('TownDetails', () => {
  it('should render successfully', () => {
    ...
    expect(screen.getByLabelText('Дэлгэрэнгүй:')).toBeInTheDocument(); // Changed from Хаяг: to Дэлгэрэнгүй:
    expect(screen.getByLabelText('Дэлгэрэнгүй:')).toHaveValue('Sample Address');
  });
  ...
  it('should call handleChange on input change', () => {
    ...
    const addressInput = screen.getByLabelText('Дэлгэрэнгүй:'); // Changed from Хаяг: to Дэлгэрэнгүй:
