...
export const SubCategoryCard = ({ title, number, value }: SubCategoryType) => {
  return (
    <Link href={`/estates?search=${title}`} className="relative h-full border rounded-sm overflow-hidden group ">
      <Image src="/cover.png" alt="Background" fill className="object-cover" priority />
