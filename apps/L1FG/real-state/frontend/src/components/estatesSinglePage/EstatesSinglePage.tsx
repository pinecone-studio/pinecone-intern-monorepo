      ...
      <div className="lg:w-2/3 p-4">
        <div className="relative">
          <div className="relative h-[500px] w-full rounded-lg overflow-hidden">
            <Image src={images[currentIndex]} fill style={{ objectFit: 'cover' }} alt={`Property image ${currentIndex + 1}`} className="transition-opacity duration-500 w-[800px] h-[700px]" priority />
