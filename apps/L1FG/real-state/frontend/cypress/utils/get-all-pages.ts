...
const root = './apps/L1FG/real-state/frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/L1FG/real-state/frontend'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
