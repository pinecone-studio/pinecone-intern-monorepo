      ...
      <div className="bg-gray-100 min-h-[500px] py-6 pt-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-6 bg-white p-6 rounded-lg shadow-lg text-gray-700 leading-relaxed">
            <p className="mb-4">
              Манай Мексик хоолны газар нь Мексикийн баялаг соёл, амттай хоолны урлагийг Монголд хүргэх зорилгоор үүсгэн байгуулагдсан. Бид амт чанартай, цэвэр, шинэхэн түүхий эдээр бэлтгэсэн
              уламжлалт Мексик хоолнуудыг та бүхэнд хүргэж байна.
            </p>
            <p className="mb-4">
            ...
            <p>
              ...
              амьсгал болон манай найрсаг үйлчилгээний мэдрүүлхээр бид өдөр бүр хичээнгүйлэн ажилладаг.
            </p>
          </div>
        </div>
      </div>
